  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6">
      ...
      <div className="space-y-1.5 sm:space-y-2">
        <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-off-white">
          Email Address
        </label>
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 sm:py-2.5 bg-olive-700/50 border rounded-lg text-sm sm:text-base text-off-white placeholder-muted-gray transition-all focus:outline-none ${
      ...
      {/* Password Field */}
      <div className="space-y-1.5 sm:space-y-2">
        <label htmlFor="password" className="block text-xs sm:text-sm font-medium text-off-white">
          Password
        </label>
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full pl-10 pr-12 py-2 sm:py-2.5 bg-olive-700/50 border rounded-lg text-sm sm:text-base text-off-white placeholder-muted-gray transition-all focus:outline-none ${
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          onChange={handleChange}
          className="w-4 h-4 bg-olive-700/50 border border-olive-600 rounded cursor-pointer accent-gold"
          disabled={isLoading}
        />
        <label htmlFor="rememberMe" className="text-xs sm:text-sm text-muted-gray cursor-pointer">
          Remember me
        </label>
      </div>
      ...
      <div className="text-right">
        <Link to="/forgot-password" className="text-xs sm:text-sm text-gold hover:text-gold-dark transition-colors">
          Forgot password?
        </Link>
      </div>
      ...
      {/* Sign Up Link */}
      <p className="text-center text-xs sm:text-sm text-muted-gray">
        Don't have an account?{' '}
        <Link to="/signup" className="text-gold hover:text-gold-dark transition-colors font-medium">
          Sign up
        </Link>
      </p>
    </form>
